...
def generate_password():
    ...
    with open("student.txt", "a+") as file:  # créé un fichier txt, w+ est le mode d'ecriture
        file.write(password + "\n")  # ecrit dans le txt de la varuiable file \n pour passer a ala ligne
        file.close()  # arreter le fichier
